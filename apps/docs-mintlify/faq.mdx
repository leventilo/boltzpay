...
<AccordionGroup>
  ...
  <Accordion title="Can I test without spending real money?">
    Yes. Set `network: "base-sepolia"` to use the Base Sepolia testnet with free test USDC. The [Nickel Joke](https://nickeljoke.vercel.app) endpoint is a testnet demo. You can also run the [local test server](/reference/registry) for fully offline testing.
  </Accordion>
